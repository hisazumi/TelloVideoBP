...
class TelloUI:
    ...
    def __init__(self,tello,outputpath):
        ...
        self.distCoeffs = np.array( [0.08554508502456,-0.92010350196053,0.00149688989845,-0.00264640962474,2.58261393703612] )
    ...
    def videoLoop(self):
        ...
        try:
            ...
            # read the frame for GUI show
                ...
                height, width, channels = self.frame.shape[:3]

                corners, ids, rejectedImgPoints = aruco.detectMarkers(self.gray_frame, self.aruco_dict, parameters=self.aruco_parameters)
                ...
                if ids is not None and ids[0][0] > 0 :
                    ...
                    for i, corner in enumerate( corners ):
                        ...
                        ar_center_xy = (ar_center_x, ar_center_y)
